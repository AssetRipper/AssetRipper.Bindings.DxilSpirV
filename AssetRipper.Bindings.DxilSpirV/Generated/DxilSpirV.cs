...
{
    [DllImport("dxil-spirv", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    ...
    [NativeTypeName("#define DXIL_SPV_API_VERSION_MINOR 44")]
    public const int DXIL_SPV_API_VERSION_MINOR = 44;
    ...
    [NativeTypeName("#define DXIL_SPV_INSTRUCTION_INSTRUMENTATION_INTERFACE_VERSION 1")]
    public const int DXIL_SPV_INSTRUCTION_INSTRUMENTATION_INTERFACE_VERSION = 1;
